...
import com.hvdbs.myapp.shared.FieldVerifier;
...
public class MyApp implements EntryPoint {
  ...
  public void onModuleLoad() {
    final Button sendButton = new Button("Send ffff");
    final Button testButton = new Button("new page");
